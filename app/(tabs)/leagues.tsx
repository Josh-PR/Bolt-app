...
export default function Leagues({ hideHeader = false }: LeaguesProps) {
  ...
  const filteredLeagues = filteredAndSortedLeagues.filter((league) => {
    const matchesSearch = league.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         league.description.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         league.location.toLowerCase().includes(searchQuery.toLowerCase());
          ...
          <View style={styles.leaguesList}>
            {filteredAndSortedLeagues.map((league) => (
              <Card key={league.id} style={styles.leagueCard}>
                ...
                <Button
                  title={league.status === 'open' ? 'View Details' : 'Full - Join Waitlist'}
                  onPress={() => {}}
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="Available Leagues" subtitle="Find and join softball leagues that match your skill level" />
      {content}
    </SafeAreaView>
  );
}
