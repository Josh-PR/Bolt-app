...
const directorSignupSchema = z.object({
  // Step 1: Basic Info
  ...
  organizationType: z.enum(['recreation', 'competitive', 'corporate', 'community']),
  yearsExperience: z.enum(['0-1', '2-5', '5-10', '10+']),
...
type DirectorSignupForm = z.infer<typeof directorSignupSchema>;
...
export default function DirectorSignup() {
  ...
  const {
    ...
    formState: { errors },
    trigger,
  } = useForm<DirectorSignupForm>({
    resolver: zodResolver(directorSignupSchema),
    defaultValues: {
      email: '',
      password: '',
      confirmPassword: '',
  ...
  const steps = [
    ...
    { title: 'Organization Details', fields: ['organizationName', 'organizationType', 'yearsExperience'] },
    { title: 'Verification', fields: ['businessLicense', 'insuranceInfo'] },
  ];
  ...
  const onSubmit = async (data: DirectorSignupForm) => {
    ...
    try {
      ...
      // Navigate to 2FA setup for directors
        ...
        return (
          <View key="step-1" nativeID="step-1-container" style={styles.stepContainer}>
            ...
            <Text style={styles.stepDescription}>
              Create your director account with enhanced security
            </Text>
      ...
      case 4:
        return (
          <View key="step-4" nativeID="step-4-container" style={styles.stepContainer}>
            ...
            <Text style={styles.stepDescription}>
              Optional information to verify your organization
            </Text>

            <Controller
              control={control}
              name="businessLicense"
              key="businessLicense-step-4"
              render={({ field: { onChange, onBlur, value } }) => (
                <TextInput
                  ...
                  textContentType="none"
                  importantForAutofill="no"
                  nativeID="businessLicense-step-4"
                />
              )}
            />
            ...
            <Controller
              control={control}
              name="insuranceInfo"
              key="insuranceInfo-step-4"
              render={({ field: { onChange, onBlur, value } }) => (
                <TextInput
                  label="Insurance Information (Optional)"
                  placeholder="Enter your insurance policy information"
                  value={value}
                  onChangeText={onChange}
                  onBlur={onBlur}
                  error={errors.insuranceInfo?.message}
                  multiline
                  numberOfLines={4}
                  autoCorrect={false}
                  autoComplete="off"
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <View style={styles.header}>
            <Text style={styles.title}>Director Registration</Text>
