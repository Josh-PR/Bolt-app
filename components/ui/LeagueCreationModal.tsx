...
export function LeagueCreationModal({
  visible,
  onClose,
  onSuccess,
}: LeagueCreationModalProps) {
        ...
        <View style={styles.modalContent}>
          ...
          <ScrollView style={styles.formContainer} showsVerticalScrollIndicator={false}>
            <TextInput
              ...
              placeholder="e.g., Summer 2024 League"
            />
            ...
            <TextInput
              label="Season Start Date * (YYYY-MM-DD)"
              value={formData.seasonStart}
              onChangeText={(text) => setFormData({ ...formData, seasonStart: text })}
              placeholder="2024-06-01"
            />

            <TextInput
              label="Season End Date * (YYYY-MM-DD)"
              value={formData.seasonEnd}
              onChangeText={(text) => setFormData({ ...formData, seasonEnd: text })}
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData({ ...formData, baseFee: text })}
              placeholder="0"
